...
\begin{figure}[h!]
	...
	\caption{I 5 pools che hanno minato più blocchi LTC.}
...
\begin{table}
	...
	\end{tabular}
	\label{seg}
	\caption{Struttura OP\_RETURN SegWit (github ufficiale, BIP141)}
\end{table} 
...
\begin{tabular}{|c|c|}
	...
	\hline 
\end{tabular} 
\caption{OP\_RETURN non nulli contenenti l'header SegWit}
\end{table}
