...
\subparagraph{Background tecnico}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.9\linewidth]{../../Documents/Tirocinio/ImgTesi/EcdsaToAddress-bstavroulakis}
...
\begin{figure}[h!]
\centering
\includegraphics[width=1.0\linewidth]{../../Documents/Tirocinio/ImgTesi/SimplifiedBlockchainBlockGeeks}
\caption{}
...
1.4.2.1. Qualche dato su litecoin (?)
...
\begin{equation}
\sum_{a}^{b}\left ( \int \frac{c}{d} \right ) + \begin{bmatrix}
5 & 7\\ 
9 & 8
\end{bmatrix} + \binom{2}{3}
\end{equation}
